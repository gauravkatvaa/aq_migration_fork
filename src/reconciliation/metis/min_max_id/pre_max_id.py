        ...
        for database, tables_list in database_tables_dict.items():
            try:
                ...
                with open(output_csv, 'a') as f:
                    f.write('Database,Table_Name,Before_Execution\n')
...
if __name__ == '__main__':
    ...
    output_csv = 'pre_max_id.csv'  # Update with your desired output CSV file

    # Specify the result column name
    result_column = "Before_Execution"  # Update accordingly when calling the function

    # Call the function to run queries and append results to CSV
