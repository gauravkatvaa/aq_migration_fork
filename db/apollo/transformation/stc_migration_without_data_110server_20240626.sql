...
MySQL - 8.0.34 : Database - stc_migration
*********************************************************************
*/
...
/*!50003 CREATE FUNCTION `SplitString`(str VARCHAR(255), delim VARCHAR(5), pos INT) RETURNS varchar(255) CHARSET utf8mb4 COLLATE utf8mb4_general_ci
BEGIN
    RETURN REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(str, delim, pos), delim, -1), '''', '');
END */$$
DELIMITER ;

/* Procedure structure for procedure `additional_bus_for_static_apns_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `additional_bus_for_static_apns_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `additional_bus_for_static_apns_cdp`()
BEGIN
...
/* Procedure structure for procedure `apn_management_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `apn_management_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `apn_management_cdp`()
BEGIN
...
/* Procedure structure for procedure `assests_details_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `assests_details_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `assests_details_cdp`(
...
/* Procedure structure for procedure `asset_extended_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `asset_extended_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `asset_extended_cdp`()
BEGIN
SELECT 
    '' AS ID,
    assets_cdp.CREATIONDATE as  CREATE_DATE ,
...
/* Procedure structure for procedure `csrj_mapping_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `csrj_mapping_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `csrj_mapping_cdp`()
BEGIN
...
/* Procedure structure for procedure `csr_mapping_details` */

/*!50003 DROP PROCEDURE IF EXISTS  `csr_mapping_details` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `csr_mapping_details`()
BEGIN
/*
...
/* Procedure structure for procedure `csr_mapping_master` */

/*!50003 DROP PROCEDURE IF EXISTS  `csr_mapping_master` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `csr_mapping_master`()
BEGIN
SELECT GROUP_CONCAT( SERVICE_PROFILE_ID SEPARATOR '&&' ) as SERVICE_PROFILE_ID
,`Customer Name`,
 `Business Unit Name`,
`Tariff Plan`,
GROUP_CONCAT( `APN` SEPARATOR '&&') AS `APN LIST`,
GROUP_CONCAT(  `Device Plan LIST` SEPARATOR '&&') AS `Device Plan LIST`,
CUSTOMER_REFERENCE,
BILLING_ACCOUNT
 FROM (
...
/* Procedure structure for procedure `customer_account_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `customer_account_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `customer_account_cdp`()
BEGIN
...
/* Procedure structure for procedure `customer_account_cdp_bu` */

/*!50003 DROP PROCEDURE IF EXISTS  `customer_account_cdp_bu` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `customer_account_cdp_bu`()
BEGIN
...
/* Procedure structure for procedure `Goup_router_bulk_upload_dumm` */

/*!50003 DROP PROCEDURE IF EXISTS  `Goup_router_bulk_upload_dumm` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `Goup_router_bulk_upload_dumm`()
BEGIN
...
/* Procedure structure for procedure `ip_pooling_22` */

/*!50003 DROP PROCEDURE IF EXISTS  `ip_pooling_22` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `ip_pooling_22`()
SELECT 
...
/* Procedure structure for procedure `ip_white_listing` */

/*!50003 DROP PROCEDURE IF EXISTS  `ip_white_listing` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `ip_white_listing`()
BEGIN
...
/* Procedure structure for procedure `lead_person_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `lead_person_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `lead_person_cdp`()
BEGIN
...
/* Procedure structure for procedure `map_user_sim_order_procedure_bulk_insert` */

/*!50003 DROP PROCEDURE IF EXISTS  `map_user_sim_order_procedure_bulk_insert` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `map_user_sim_order_procedure_bulk_insert`()
BEGIN
...
/* Procedure structure for procedure `migration_api_user` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_api_user` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_api_user`()
BEGIN
...
/* Procedure structure for procedure `migration_assets_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_assets_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_assets_cdp`()
BEGIN
...
/* Procedure structure for procedure `migration_device_plan_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_device_plan_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_device_plan_cdp`()
BEGIN
...
/* Procedure structure for procedure `migration_map_user_sim_order` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_map_user_sim_order` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_map_user_sim_order`(
...
/* Procedure structure for procedure `migration_order_shipping_status` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_order_shipping_status` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_order_shipping_status`( 
    IN in_order_shipping_id INT
    )
BEGIN
DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
...
/* Procedure structure for procedure `migration_sim_event_log` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_sim_event_log` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_sim_event_log`(
...
/* Procedure structure for procedure `migration_sim_event_log_old` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_sim_event_log_old` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_sim_event_log_old`( 
    IN in_sim_event_log_id INT
    )
BEGIN
DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
...
/* Procedure structure for procedure `migration_sim_provisioned_range_details` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_sim_provisioned_range_details` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_sim_provisioned_range_details`(in in_sim_provisioned_range_id int)
BEGIN
SELECT 
...
/* Procedure structure for procedure `migration_sim_range` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_sim_range` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_sim_range`(
...
/* Procedure structure for procedure `migration_tag` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_tag` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_tag`(IN id_in INT)
BEGIN
 SELECT 
...
/* Procedure structure for procedure `migration_tag_details` */

/*!50003 DROP PROCEDURE IF EXISTS  `migration_tag_details` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `migration_tag_details`()
BEGIN
...
/* Procedure structure for procedure `sim_products_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `sim_products_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `sim_products_cdp`(
	IN `in_opco_id` INT
)
BEGIN
...
/* Procedure structure for procedure `sim_provisioned_range_details` */

/*!50003 DROP PROCEDURE IF EXISTS  `sim_provisioned_range_details` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `sim_provisioned_range_details`()
BEGIN
...
/* Procedure structure for procedure `sim_range_procedure_bulk_insert` */

/*!50003 DROP PROCEDURE IF EXISTS  `sim_range_procedure_bulk_insert` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `sim_range_procedure_bulk_insert`()
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
GET DIAGNOSTICS CONDITION 1
...
/* Procedure structure for procedure `SplitAndInsert` */

/*!50003 DROP PROCEDURE IF EXISTS  `SplitAndInsert` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `SplitAndInsert`()
BEGIN
    DECLARE done INT DEFAULT FALSE;
    DECLARE bu_part VARCHAR(255);
    DECLARE cdp_apn VARCHAR(255);
...
/* Procedure structure for procedure `SplitBuId` */

/*!50003 DROP PROCEDURE IF EXISTS  `SplitBuId` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `SplitBuId`()
BEGIN
    DECLARE done INT DEFAULT FALSE;
...
/* Procedure structure for procedure `sp_split` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_split` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `sp_split`(IN toSplit text, IN target char(255))
BEGIN
...
/* Procedure structure for procedure `tag_details` */

/*!50003 DROP PROCEDURE IF EXISTS  `tag_details` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `tag_details`()
BEGIN
...
/* Procedure structure for procedure `user_management_cdp` */

/*!50003 DROP PROCEDURE IF EXISTS  `user_management_cdp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `user_management_cdp`()
BEGIN
SELECT 
  distinct CPDID,
  primaryPhone,
