...
-- Dumping structure for table stc_migration.accounts
...
-- Dumping structure for table stc_migration.acct_att_cdp
DROP TABLE IF EXISTS `acct_att_cdp`;
CREATE TABLE IF NOT EXISTS `acct_att_cdp` (
...
-- Dumping structure for procedure stc_migration.additional_bus_for_static_apns_cdp
DROP PROCEDURE IF EXISTS `additional_bus_for_static_apns_cdp`;
DELIMITER //
CREATE PROCEDURE `additional_bus_for_static_apns_cdp`()
BEGIN
...
-- Dumping structure for table stc_migration.address_details_cdp
DROP TABLE IF EXISTS `address_details_cdp`;
CREATE TABLE IF NOT EXISTS `address_details_cdp` (
...
-- Dumping structure for table stc_migration.apns_cdp
DROP TABLE IF EXISTS `apns_cdp`;
CREATE TABLE IF NOT EXISTS `apns_cdp` (
  `ID` int DEFAULT NULL,
...
-- Dumping structure for table stc_migration.apn_ip_addressess_cdp
DROP TABLE IF EXISTS `apn_ip_addressess_cdp`;
CREATE TABLE IF NOT EXISTS `apn_ip_addressess_cdp` (
  `ID` int DEFAULT NULL,
...
-- Dumping structure for table stc_migration.apn_ip_pools_state_t_cdp
DROP TABLE IF EXISTS `apn_ip_pools_state_t_cdp`;
CREATE TABLE IF NOT EXISTS `apn_ip_pools_state_t_cdp` (
  `ID` int DEFAULT NULL,
...
-- Dumping structure for table stc_migration.apn_sp_cdp
DROP TABLE IF EXISTS `apn_sp_cdp`;
CREATE TABLE IF NOT EXISTS `apn_sp_cdp` (
  `APN_ID` int DEFAULT NULL,
...
-- Dumping structure for table stc_migration.assets_cdp
DROP TABLE IF EXISTS `assets_cdp`;
CREATE TABLE IF NOT EXISTS `assets_cdp` (
...
-- Dumping structure for table stc_migration.assets_cdp_1
DROP TABLE IF EXISTS `assets_cdp_1`;
CREATE TABLE IF NOT EXISTS `assets_cdp_1` (
  `IMSI` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ICCID` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MSISDN` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for table stc_migration.assets_cdp_2
DROP TABLE IF EXISTS `assets_cdp_2`;
CREATE TABLE IF NOT EXISTS `assets_cdp_2` (
  `IMSI` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ICCID` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MSISDN` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `OPCO_ID` int DEFAULT NULL,
...
-- Dumping structure for procedure stc_migration.asset_extended_cdp
DROP PROCEDURE IF EXISTS `asset_extended_cdp`;
DELIMITER //
CREATE PROCEDURE `asset_extended_cdp`()
BEGIN
SELECT 
    '' AS ID,
    assets_cdp.CREATIONDATE as  CREATE_DATE ,
...
-- Dumping structure for table stc_migration.billing_account_cdp
DROP TABLE IF EXISTS `billing_account_cdp`;
CREATE TABLE IF NOT EXISTS `billing_account_cdp` (
  ...
  `BU_NAME` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Data exporting was unselected.

-- Dumping structure for table stc_migration.cost_center_cdp
DROP TABLE IF EXISTS `cost_center_cdp`;
CREATE TABLE IF NOT EXISTS `cost_center_cdp` (
...
-- Dumping structure for procedure stc_migration.csrj_mapping_cdp
DROP PROCEDURE IF EXISTS `csrj_mapping_cdp`;
DELIMITER //
CREATE PROCEDURE `csrj_mapping_cdp`()
BEGIN
...
NULL as `Adjustments Amount` FROM PAYG_LOCAL_NBIOT_DATA INNER JOIN customer_details_cdp ON customer_details_cdp.BU_ID=service_profile_config_cdp.BUID AND customer_details_cdp.SERVICE_PROFILE_ID=service_profile_config_cdp.SERVICE_PROFILE_ID WHERE service_profile_config_cdp.`STATUS`='Enabled';


END//
DELIMITER ;

-- Dumping structure for procedure stc_migration.csr_mapping_details
...
NULL as `Account Level Discount Name`
...
-- Dumping structure for procedure stc_migration.csr_mapping_master
DROP PROCEDURE IF EXISTS `csr_mapping_master`;
DELIMITER //
CREATE PROCEDURE `csr_mapping_master`()
BEGIN
...
SELECT  distinct service_profile_config_cdp.CUSTNAME AS `Customer Name`,
      service_profile_config_cdp.BUNAME AS  `Business Unit Name`,
		 ...
		 billing_account_cdp.BILLING_ACCOUNT AS BILLING_ACCOUNT
		  FROM service_profile_config_cdp INNER JOIN customer_details_cdp ON customer_details_cdp.BU_ID=service_profile_config_cdp.BUID AND customer_details_cdp.SERVICE_PROFILE_ID=service_profile_config_cdp.SERVICE_PROFILE_ID  INNER JOIN acct_att_cdp ON acct_att_cdp.CUSTOMER_ID=customer_details_cdp.CUSTOMER_ID INNER JOIN billing_account_cdp ON billing_account_cdp.BUID=service_profile_config_cdp.BUID  WHERE service_profile_config_cdp.`STATUS`='Enabled' )csr_master 
          GROUP BY `Customer Name`,`Business Unit Name`,`Tariff Plan`;

END//
DELIMITER ;

-- Dumping structure for procedure stc_migration.customer_account_cdp
DROP PROCEDURE IF EXISTS `customer_account_cdp`;
DELIMITER //
CREATE PROCEDURE `customer_account_cdp`()
BEGIN
...
-- customer_details_cdp.BUNAME AS billingAccountName,
-- customer_details_cdp.BUNAME AS businessUnitName,
billing_account_cdp.BU_NAME AS businessUnitName,
-- customer_details_cdp.BU_ID,
...
-- AND  customer_details_cdp.BU_ID=billing_account_cdp.BUID
...
-- Dumping structure for procedure stc_migration.customer_account_cdp_bu
DROP PROCEDURE IF EXISTS `customer_account_cdp_bu`;
DELIMITER //
CREATE PROCEDURE `customer_account_cdp_bu`()
BEGIN
...
-- Dumping structure for table stc_migration.customer_details_cdp
DROP TABLE IF EXISTS `customer_details_cdp`;
CREATE TABLE IF NOT EXISTS `customer_details_cdp` (
  `CUSTOMER_ID` int DEFAULT NULL,
  `CUSTOMER_NAME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for procedure stc_migration.Goup_router_bulk_upload_dumm
DROP PROCEDURE IF EXISTS `Goup_router_bulk_upload_dumm`;
DELIMITER //
CREATE PROCEDURE `Goup_router_bulk_upload_dumm`()
BEGIN
...
-- Dumping structure for table stc_migration.imsi_range_cdp
DROP TABLE IF EXISTS `imsi_range_cdp`;
CREATE TABLE IF NOT EXISTS `imsi_range_cdp` (
...
-- Dumping structure for table stc_migration.imsi_range_cdp_tmp
DROP TABLE IF EXISTS `imsi_range_cdp_tmp`;
CREATE TABLE IF NOT EXISTS `imsi_range_cdp_tmp` (
  `CTX_ID` int DEFAULT NULL,
  `POOL_ID` int DEFAULT NULL,
  `CRMCUSTOMER_ID` int DEFAULT NULL,
  `IMSI_START` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for procedure stc_migration.ip_pooling_22
DROP PROCEDURE IF EXISTS `ip_pooling_22`;
DELIMITER //
CREATE PROCEDURE `ip_pooling_22`()
SELECT 
...
-- Dumping structure for procedure stc_migration.ip_white_listing
DROP PROCEDURE IF EXISTS `ip_white_listing`;
DELIMITER //
CREATE PROCEDURE `ip_white_listing`()
BEGIN
...
-- Dumping structure for table stc_migration.lable_source
DROP TABLE IF EXISTS `lable_source`;
CREATE TABLE IF NOT EXISTS `lable_source` (
...
-- Dumping structure for procedure stc_migration.lead_person_cdp
DROP PROCEDURE IF EXISTS `lead_person_cdp`;
DELIMITER //
CREATE PROCEDURE `lead_person_cdp`()
BEGIN
...
-- Dumping structure for table stc_migration.map_user_sim_order
DROP TABLE IF EXISTS `map_user_sim_order`;
CREATE TABLE IF NOT EXISTS `map_user_sim_order` (
  `id` bigint NOT NULL AUTO_INCREMENT,
...
-- Dumping structure for procedure stc_migration.map_user_sim_order_procedure_bulk_insert
...
-- Dumping structure for procedure stc_migration.migration_api_user
DROP PROCEDURE IF EXISTS `migration_api_user`;
DELIMITER //
CREATE PROCEDURE `migration_api_user`()
BEGIN
SELECT DISTINCT LOGIN,
	...
	EMAIL,
	'False' AS locked,
	"1,72,1,58,1,75,1,90,1,70,1,91,1,60,1,78,1,62,1,121,1,122,1,126,1,123,1,130,1,131,1,127,1,128,1,55,1,196,1,8,1,9,1,61,1,108,1,116,1,108,1,125,1,129,1,66,1,2,1,74,1,59,1,79,1,84,1,85,1,86,1,87,1,88,1,89,1,97,1,98,1,92,1,124,1,80,1,115,1,82,1,83,1,132,1,134,1,135,1,136,1,137,1,138,1,139,1,140,1,141,1,142,1,143,1,144,1,145,1,146,1,147,1,137,1,133,1,137,1,153,1,157,1,158,1,148,1,149,1,150,1,151,1,152,1,154,1,155,1,156,1,159,1,160,1,161,1,162,1,163,1,164,1,165,1,115,1,280,1,202,1,201,1,203,1,224,1,204,1,206,1,205,1,211,1,223,1,225,1,207,1,256,1,257,1,258,1,259,1,260,1,261,1,262,1,266,1,267,1,281,1,319,1,314,1,315,1,316,1,305,1,306,1,307,1,308,1,309,1,310,1,311,1,312,1,313,1,317,1" as apiMappingIds,
	'[]' AS states,
	NULL AS reason,
...
-- Dumping structure for table stc_migration.migration_assets
...
-- Dumping structure for procedure stc_migration.migration_device_plan_cdp
DROP PROCEDURE IF EXISTS `migration_device_plan_cdp`;
DELIMITER //
CREATE PROCEDURE `migration_device_plan_cdp`()
BEGIN
...
-- Dumping structure for procedure stc_migration.migration_map_user_sim_order
DROP PROCEDURE IF EXISTS `migration_map_user_sim_order`;
DELIMITER //
CREATE PROCEDURE `migration_map_user_sim_order`(
...
-- IF (start_date= 'null', NULL,STR_TO_DATE(LEFT(start_date,22),'%d-%b-%y %H.%i.%s.%f')) AS create_date ,
...
-- Dumping structure for table stc_migration.migration_map_user_sim_order
...
-- Dumping structure for table stc_migration.migration_map_user_sim_order_error_history
...
-- Dumping structure for procedure stc_migration.migration_order_shipping_status
DROP PROCEDURE IF EXISTS `migration_order_shipping_status`;
DELIMITER //
CREATE PROCEDURE `migration_order_shipping_status`( 
    IN in_order_shipping_id INT
    )
BEGIN
DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
...
-- Dumping structure for table stc_migration.migration_order_shipping_status
...
-- Dumping structure for table stc_migration.migration_order_shipping_status_error_history
DROP TABLE IF EXISTS `migration_order_shipping_status_error_history`;
CREATE TABLE IF NOT EXISTS `migration_order_shipping_status_error_history` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `updated_date` datetime DEFAULT NULL,
  `shipped_at` datetime DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
...
-- Dumping structure for procedure stc_migration.migration_sim_event_log
DROP PROCEDURE IF EXISTS `migration_sim_event_log`;
DELIMITER //
CREATE PROCEDURE `migration_sim_event_log`(
...
-- Dumping structure for table stc_migration.migration_sim_event_log
...
-- Dumping structure for procedure stc_migration.migration_sim_event_log_old
DROP PROCEDURE IF EXISTS `migration_sim_event_log_old`;
DELIMITER //
CREATE PROCEDURE `migration_sim_event_log_old`( 
    IN in_sim_event_log_id INT
    )
BEGIN
DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
...
-- Dumping structure for procedure stc_migration.migration_sim_provisioned_range_details
DROP PROCEDURE IF EXISTS `migration_sim_provisioned_range_details`;
DELIMITER //
CREATE PROCEDURE `migration_sim_provisioned_range_details`(in in_sim_provisioned_range_id int)
BEGIN
SELECT 
...
FROM assets_cdp INNER JOIN billing_account_cdp ON assets_cdp.BU_ID=billing_account_cdp.BUID
INNER JOIN acct_att_cdp ON acct_att_cdp.CUSTOMER_ID=billing_account_cdp.CUSTOMER_ID 
-- WHERE SIM_STATUS IN('A','S','V')
GROUP BY assets_cdp.IMSI;
    END//
DELIMITER ;

-- Dumping structure for table stc_migration.migration_sim_provisioned_range_details
...
-- Dumping structure for table stc_migration.migration_sim_provisioned_range_details_error_history
...
-- Dumping structure for table stc_migration.migration_sim_range
...
-- Dumping structure for procedure stc_migration.migration_sim_range
DROP PROCEDURE IF EXISTS `migration_sim_range`;
DELIMITER //
CREATE PROCEDURE `migration_sim_range`(
...
START TRANSACTION;
/*    
ALTER TABLE `sim_order_cdp` 
CHANGE `SIM_QUANTITY` `SIM_QUANTITY` INT(11) NULL, 
CHANGE `SIM_ORDER_OPCO_FIRST_ICCID` `SIM_ORDER_OPCO_FIRST_ICCID` BIGINT(20) NULL,
CHANGE  SIM_ORDER_FROM_OPCO_FIRST_IMSI SIM_ORDER_FROM_OPCO_FIRST_IMSI BIGINT(20) NULL
; */
...
-- Dumping structure for table stc_migration.migration_sim_range_error_history
...
-- Dumping structure for procedure stc_migration.migration_tag
DROP PROCEDURE IF EXISTS `migration_tag`;
DELIMITER //
CREATE PROCEDURE `migration_tag`(IN id_in INT)
BEGIN
 SELECT 
...
-- Dumping structure for table stc_migration.migration_tag
...
-- Dumping structure for table stc_migration.migration_tag_1
DROP TABLE IF EXISTS `migration_tag_1`;
CREATE TABLE IF NOT EXISTS `migration_tag_1` (
  `id` bigint unsigned NOT NULL DEFAULT '0',
  `NAME` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `notification_uuid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for procedure stc_migration.migration_tag_details
DROP PROCEDURE IF EXISTS `migration_tag_details`;
DELIMITER //
CREATE PROCEDURE `migration_tag_details`()
BEGIN
...
-- Dumping structure for table stc_migration.migration_tag_error_history
...
-- Dumping structure for table stc_migration.migration_tracking_history
...
-- Dumping structure for table stc_migration.service_profile_config_cdp
DROP TABLE IF EXISTS `service_profile_config_cdp`;
CREATE TABLE IF NOT EXISTS `service_profile_config_cdp` (
...
-- Dumping structure for table stc_migration.sim_event_log
...
-- Dumping structure for table stc_migration.sim_orders_ap_fp_status
DROP TABLE IF EXISTS `sim_orders_ap_fp_status`;
CREATE TABLE IF NOT EXISTS `sim_orders_ap_fp_status` (
...
-- Dumping structure for table stc_migration.sim_order_cdp
DROP TABLE IF EXISTS `sim_order_cdp`;
CREATE TABLE IF NOT EXISTS `sim_order_cdp` (
  ...
  `SIM_ORDER_CUST_DELIVERY_AREA` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_ORDER_CUST_DELIVERY_CITY` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_ORDER_CUST_DELVERY_COUNTRY` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_ORDER_CUST_DELVRY_POST_COD` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dumping structure for table stc_migration.sim_products_cdp
DROP TABLE IF EXISTS `sim_products_cdp`;
CREATE TABLE IF NOT EXISTS `sim_products_cdp` (
...
-- Dumping structure for procedure stc_migration.sim_products_cdp
DROP PROCEDURE IF EXISTS `sim_products_cdp`;
DELIMITER //
CREATE PROCEDURE `sim_products_cdp`(
	IN `in_opco_id` INT
)
BEGIN
...
-- Dumping structure for procedure stc_migration.sim_provisioned_range_details
...
-- Dumping structure for table stc_migration.sim_provisioned_range_details
DROP TABLE IF EXISTS `sim_provisioned_range_details`;
CREATE TABLE IF NOT EXISTS `sim_provisioned_range_details` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `CREATE_DATE` datetime NOT NULL,
  `ICCID` varchar(32) DEFAULT NULL,
  `IMSI` varchar(20) DEFAULT NULL,
...
-- Dumping structure for table stc_migration.sim_range
DROP TABLE IF EXISTS `sim_range`;
CREATE TABLE IF NOT EXISTS `sim_range` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `CREATE_DATE` datetime NOT NULL,
  `BATCH_NUMBER` bigint DEFAULT NULL,
  `ACCOUNT_ID` bigint DEFAULT NULL,
...
-- Dumping structure for table stc_migration.sim_range_1
DROP TABLE IF EXISTS `sim_range_1`;
CREATE TABLE IF NOT EXISTS `sim_range_1` (
  `ID` bigint NOT NULL AUTO_INCREMENT,
  `CREATE_DATE` datetime NOT NULL,
  `BATCH_NUMBER` bigint DEFAULT NULL,
  `ACCOUNT_ID` bigint DEFAULT NULL,
...
-- Dumping structure for procedure stc_migration.sim_range_procedure_bulk_insert
...
-- Dumping structure for table stc_migration.sim_range_tmp
DROP TABLE IF EXISTS `sim_range_tmp`;
CREATE TABLE IF NOT EXISTS `sim_range_tmp` (
  `CREATE_DATE` datetime NOT NULL,
  `BATCH_NUMBER` double DEFAULT NULL,
...
-- Dumping structure for table stc_migration.sim_transactions_cdp
DROP TABLE IF EXISTS `sim_transactions_cdp`;
CREATE TABLE IF NOT EXISTS `sim_transactions_cdp` (
  `ID` int DEFAULT NULL,
  ...
  `TRX_TYPE` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CHANG_SERV_PROF_SERVI_PROF_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SERVICE_PROFILE_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_ACTIVATON_SIM_LIFECYCLE_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `IMSI` longtext COLLATE utf8mb4_general_ci,
  `MSISDN` longtext COLLATE utf8mb4_general_ci,
  `ICCID` longtext COLLATE utf8mb4_general_ci,
  `AUTHORIZATION_TOKEN` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `BUSINESS_UNIT_ID` int DEFAULT NULL,
  `BU_LIST` text COLLATE utf8mb4_general_ci,
  `CASE_ID` int DEFAULT NULL,
  `CC_LIST` text COLLATE utf8mb4_general_ci,
  `CHANGE_SERVICE_PROFILE_LOCALE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CHANG_SERV_PROF_SIM_LIFCYCL_ID` int DEFAULT NULL,
  `MOVE_SIM_SOURCE_BU_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MOVE_SIM_TARGET_BU_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `MOVE_SIM_TARGET_CC_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `NIC_REFERENCE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `OPCO_FROM` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `OPCO_TO` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `REJECTION_REASON` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_ACTIVATE_DELIV_RECEPT` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SAVE_AS_SMS_TEMPLATE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SMS_CONTENT` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SEND_SMS_SMS_DEFINITION` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SMS_TEMPLATE_DESCRIPT` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SMS_TEMPLATE_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SMS_TEMPLATE_NAME` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SMS_TYPE` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SEND_SMS_SOURCE_BU_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_ALLOCATION_BU_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_DATA_UPDATE_FREE_TEXT` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_DATA_UPDATE_IMEI` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_DATA_UPDATE_IP` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `IS_ESIM` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `IS_BLANK` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_REPLACEMENT_ICCID_FROM` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_REPLACEMENT_ICCID_TO` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_REPLACEMENT_IMSI_FROM` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_REPLACEMENT_IMSI_TO` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_REPLACEMENT_MSISDN_FROM` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_REPLACEMENT_MSISDN_TO` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_SUSPENSION_AUTO_RSUM_ENBL` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SIM_TERMINATION_MIN_CONT_DURA` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SP_LIST` text COLLATE utf8mb4_general_ci,
  `SUSPENSION_TYPE` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SWAP_MSISDN_MSISDN_FROM` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SWAP_MSISDN_MSISDN_TO` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TARGET_DATE` datetime DEFAULT NULL,
  `TRANSACTION_CONTEXT` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TRIGGER_ID` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TRIGGER_SEND_SMS_IMSI` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TRIGGER_SEND_SMS_MESSAGE` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TRIGGER_SEND_SMS_PHONE` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `STATUS` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Data exporting was unselected.

-- Dumping structure for table stc_migration.sim_transactions_cdp1
DROP TABLE IF EXISTS `sim_transactions_cdp1`;
CREATE TABLE IF NOT EXISTS `sim_transactions_cdp1` (
  ...
  `MSISDN` longtext COLLATE utf8mb4_general_ci,
  `TRX_TYPE` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SUSPENSION_TYPE` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TRANSACTION_CONTEXT` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `START_DATE` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Data exporting was unselected.

-- Dumping structure for procedure stc_migration.SplitAndInsert
DROP PROCEDURE IF EXISTS `SplitAndInsert`;
DELIMITER //
...
-- Dumping structure for procedure stc_migration.SplitBuId
DROP PROCEDURE IF EXISTS `SplitBuId`;
DELIMITER //
CREATE PROCEDURE `SplitBuId`()
BEGIN
    DECLARE done INT DEFAULT FALSE;
...
-- Dumping structure for function stc_migration.SplitString
DROP FUNCTION IF EXISTS `SplitString`;
DELIMITER //
CREATE FUNCTION `SplitString`(str VARCHAR(255), delim VARCHAR(5), pos INT) RETURNS varchar(255) CHARSET utf8mb4 COLLATE utf8mb4_general_ci
BEGIN
    RETURN REPLACE(SUBSTRING_INDEX(SUBSTRING_INDEX(str, delim, pos), delim, -1), '''', '');
END//
DELIMITER ;

-- Dumping structure for procedure stc_migration.sp_split
...
-- Dumping structure for procedure stc_migration.tag_details
...
-- Dumping structure for table stc_migration.triggers_cdp
DROP TABLE IF EXISTS `triggers_cdp`;
CREATE TABLE IF NOT EXISTS `triggers_cdp` (
...
-- Dumping structure for table stc_migration.users_details_cdp
DROP TABLE IF EXISTS `users_details_cdp`;
CREATE TABLE IF NOT EXISTS `users_details_cdp` (
...
-- Dumping structure for procedure stc_migration.user_management_cdp
DROP PROCEDURE IF EXISTS `user_management_cdp`;
DELIMITER //
CREATE PROCEDURE `user_management_cdp`()
BEGIN
SELECT 
  distinct CPDID,
  primaryPhone,
...
-- Dumping structure for table stc_migration.white_listing_cdp
DROP TABLE IF EXISTS `white_listing_cdp`;
CREATE TABLE IF NOT EXISTS `white_listing_cdp` (
