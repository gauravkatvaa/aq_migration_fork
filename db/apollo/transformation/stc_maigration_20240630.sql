...
case when assets_cdp.ACTIVATIONDATE='0001-01-01 00:00:00' then NOW()  when assets_cdp.ACTIVATIONDATE is null then Now() else ACTIVATIONDATE end as CREATE_DATE,
assets_cdp.ICCID  AS ICCID,
assets_cdp.IMSI   AS IMSI,
assets_cdp.MSISDN AS MSISDN,
...
SELECT 
  ...
  t1.CREATE_DATE,
  CAST(t1.BATCH_NUMBER AS DECIMAL(20)) as BATCH_NUMBER,
  t1.ACCOUNT_ID,
 ROW_NUMBER() OVER () +in_map_user_sim_id AS ORDER_ID,
  t1.NAME,
  t1.DESCRIPTION,
  ...
  t1.SIM_COUNT,
  t1.SIM_CATEGORY,
  CAST(t1.ICCID_FROM AS decimal(20)) AS ICCID_FROM,
  CAST(t1.ICCID_TO AS DECIMAL(20)) as ICCID_TO,
  t1.SENDER,
  t1.ALLOCATE_TO,
  t1.ALLOCATE_DATE,
  t1.RANGE_AVAILABLE,
  ...
  t1.DELETED,
  t1.DELETED_DATE,
  CAST(t1.IMSI_FROM AS DECIMAL(20)) as IMSI_FROM,
  CAST(t1.IMSI_TO AS DECIMAL(20)) as IMSI_TO,
  t1.MSISDN_FROM,
  t1.MSISDN_TO,
  t1.ORDER_NUMBER,
  t1.ICCID_COUNT,
...
-- Dump completed on 2024-07-01  5:40:46
