...
SET SQL_MODE=@OLDTMP_SQL_MODE;
 ...
 ALTER TABLE `sim_home_identifiers` CHANGE `name` `name` VARCHAR(64) CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT 'name if unique sim id Such as iccid,ban,imsi etc', 
 CHANGE `sim_id` `sim_id` VARCHAR(64) CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT 'value of sim identifier', 
 CHANGE `sim_identifier_value` `sim_identifier_value` VARCHAR(64) CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL;

 ALTER TABLE `migration_assets`   
  CHANGE `ICCID` `ICCID` VARCHAR(32) CHARSET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  CHANGE `IMSI` `IMSI` VARCHAR(32) CHARSET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  CHANGE `MSISDN` `MSISDN` VARCHAR(32) CHARSET utf8mb3 COLLATE utf8mb3_general_ci NULL,
  CHANGE `UUID` `UUID` VARCHAR(64) CHARSET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL;
